module github.com/terui-ryota/admin

go 1.22.0

require (
	github.com/ca-media-nantes/libgo/v2 v2.44.0
	github.com/ca-media-nantes/pick/backend/admin v1.13.0
...
require (
	...
	github.com/ca-media-nantes/appmng/pb/appmng_cbac v1.24.4 // indirect
	github.com/ca-media-nantes/idmap/pb/idmap v1.13.0 // indirect
	github.com/ca-media-nantes/pick/go-lib v1.20.0 // indirect
	github.com/ca-media-nantes/pick/protofiles v1.93.0 // indirect
	...
	github.com/ladydascalie/sqlerr v0.0.0-20180223115022-3fdf40761662 // indirect
